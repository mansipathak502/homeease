...
// Payments — NOTE: fixed routes MUST come before /:id param routes
router.get('/payments/summary',           adminController.getPaymentSummary);    // ✅ fixed: was getEarningsSummary

router.get('/payments/global-commission', adminController.getGlobalCommission); 
router.put('/payments/global-commission', adminController.setGlobalCommission);  // ✅ must be before /:id
router.get('/payments',                   adminController.getPayments);
router.put('/payments/:id/commission',    adminController.setCommission);
router.put('/payments/:id/payout-done',   adminController.markPayoutDone);
