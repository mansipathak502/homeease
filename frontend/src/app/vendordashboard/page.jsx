...
export default function VendorDashboard() {
  ...
  const handleSendQuote = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/vendor/bookings/${selectedBk.id}/quote`, {        method: "POST",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
      ...
      <ModalCard>
        ...
        <div style={{ display:"flex", gap:8 }}>
          <button onClick={() => setShowPaymentModal(false)}
            style={{ flex:1, padding:12, borderRadius:8, border:`1px solid ${T.darkBorder2}`,
          ...
          <button onClick={handleFinalPayment} disabled={!paymentMethod || actionLoading}
            style={{ flex:2, padding:12, borderRadius:8, border:"none", background:"#059669",
